    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (sender instanceof Player) {
            if (args.length == 1) {
                ...
                return Utilities.possibilityChecker(possible, args[0]);
                ...
                if (args[0].equalsIgnoreCase("r") || args[0].equalsIgnoreCase("randomize")) {
                    ...
                    return Utilities.possibilityChecker(possible, args[1]);
                ...
                if (args[1].equalsIgnoreCase("remove")) {
                    ...
                    return Utilities.possibilityChecker(possible, args[2]);
                }
                ...
                if (args[1].equalsIgnoreCase("add")) {
                    ...
                    return Utilities.possibilityChecker(possible, args[3]);
                }
            }
        }
